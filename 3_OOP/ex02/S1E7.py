...
# self: reference to the instance of the class, refers to itself and work with
# 		its own data
# cls: reference to the class itself, not an instance of the class
#     - allows you to work with class level attributes and methods, which is
